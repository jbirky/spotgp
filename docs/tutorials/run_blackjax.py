...
sys.path.append("../..")
from src_jax.starspot import LightcurveModel
from src_jax.mcmc import BlackJAXSampler
from src_jax.gp_solver import GPSolver
import corner
...
np.savez("blackjax_mcmc_results.npz", samples=np.array(samples), info=info, theta_map=theta_map, theta_true=theta_true, theta_full=theta_full)
